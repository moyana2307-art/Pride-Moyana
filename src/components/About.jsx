      ...
      <section className="about-main">
        ...
        <div className="interests-block">
          ...
          <div className="interests-tags">
            <span><i className="fas fa-palette"></i> UI Design Trends</span>
            <span><i className="fas fa-microchip"></i> System Automation</span>
            <span><i className="fas fa-book-open"></i> Technical Mentorship</span>
          </div>
        </div>
      </section>
    </div>
