const projects = [
  {
    ...
    demo: 'https://africa-rising-safaris.vercel.app/',
  },
  {
    title: 'Flames Restaurant Website',
    description: 'A modern restaurant website featuring an interactive menu, online reservation system, and engaging UI to enhance customer experience and brand presence. (Collaboration)',
    icon: 'fas fa-layer-group',
    tags: ['HTML5', 'CSS3', 'JavaScript', 'Collaboration'],
